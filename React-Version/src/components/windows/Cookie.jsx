  ...
  return (
    <div className="bg-[#c0c0c0] w-full h-screen flex flex-col p-0 m-0">
      ...
      <div className="flex justify-end p-1">
        <div className="relative group">
          ...
          <div className="absolute right-0 top-full mt-[2px] w-72 bg-[#c0c0c0] p-2 border-t-[2px] border-l-[2px]  border-b-[2px] border-r-[2px] border-[#6d6d6d] 
            ...
            Este es un juego creado usando el generador v0, con React y TailwindCSS, clon del famoso{' '}
            <a href="https://cookieclicker.com/" className="text-blue-800 underline" target="_blank">
              Cookie Clicker
            </a>{' '}
            de Orteil. Hecho como hobby. Repo:{' '}
            <a className="text-blue-800 underline" target="_blank" href="https://github.com/ivaniraldi/cookie-clicker-clone">
              GitHub
            </a>{' '}
            | Demo:{' '}
            <a className="text-blue-800 underline" target="_blank" href="https://cookie-clicker-clone.onrender.com/">
              Ver
            </a>
          </div>
        </div>
      ...
      <div className="flex-1 bg-[#c0c0c0] p-0 m-0">
        <iframe
          src="https://cookie-clicker-clone.onrender.com/"
