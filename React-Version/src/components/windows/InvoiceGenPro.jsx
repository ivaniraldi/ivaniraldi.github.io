  ...
  return (
    <div className="bg-[#c0c0c0] w-full h-screen flex flex-col p-0 m-0">
      ...
      <div className="flex justify-end p-1">
        <div className="relative group">
          ...
          <div className="absolute right-0 top-full mt-[2px] w-72 bg-[#c0c0c0] p-2 border-t-[2px] border-l-[2px]  border-b-[2px] border-r-[2px] border-[#6d6d6d] 
            ...
            Web desarrollada como herramienta para crear facturas de forma rapida y gratuita, con integracion de IA. Repo:{' '}
            <a className="text-blue-800 underline" target="_blank" href="https://github.com/ivaniraldi/InvoiceGenPro">
              GitHub
            </a>{' '}
            | Demo:{' '}
            <a className="text-blue-800 underline" target="_blank" href="https://ivaniraldi.github.io/InvoiceGenPro/">
              Ver
            </a>
          </div>
        </div>
      ...
      <div className="flex-1 bg-[#c0c0c0] p-0 m-0">
        <iframe
          src="https://ivaniraldi.github.io/InvoiceGenPro/"
