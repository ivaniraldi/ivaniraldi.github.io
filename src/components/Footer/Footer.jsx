...
export default function Footer() {
    return (
        <section className="bg-none" id='contact'>
            <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center mt-8 space-x-6">
                    <a href="https://www.facebook.com/profile.php?id=100071325024533" className="text-black-400 hover:text-black-500">
                    ...
                    <a href="https://github.com/ivaniraldi" className="text-black-400 hover:text-black-500">
